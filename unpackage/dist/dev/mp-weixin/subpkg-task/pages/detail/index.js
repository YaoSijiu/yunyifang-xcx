...
var _index = _interopRequireDefault(__webpack_require__(/*! ./subpkg-task/pages/detail/index.vue */ 273));
// @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_53280496_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=53280496&scoped=true& */ 274);
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ 276);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _index_vue_vue_type_style_index_0_id_53280496_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=53280496&lang=scss&scoped=true& */ 278);
...
var _default = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _this.pendingAutoAction = options && options.autoAction ? String(options.autoAction) : '';
              if (_this.isLoggedIn) {
                uni.showShareMenu({
  ...
  methods: {
    ...
    normalizeBidders: function normalizeBidders(data) {
      ...
      var isQuoteStatusValid = function isQuoteStatusValid(status) {
        if (status === null || status === undefined || status === '') return false;
        return VALID_QUOTE_STATUS.has(String(status).toLowerCase());
      };
      var isOrderStatusValid = function isOrderStatusValid(status) {
      ...
      acceptListCandidates.forEach(function (list) {
        ...
        list.forEach(function (item) {
          if (!item) return;
          var orderStatus = item.orderStatus || item.status;
    ...
    triggerAutoAction: function triggerAutoAction() {
